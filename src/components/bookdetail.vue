  ...
  <div>
      ...
      <div class="bookdetail">
        ...
        <div class="content6">  
            ...
            <p>
                <span>书架号:</span><span>{{ data.bookrackId }}</span>
            </p>
            <p>
                <span>状态:</span><span>{{ data.status }}</span>
            </p>
            <p>
                <span>分类:</span><span>{{ data.classify }}</span>
            </p>
            <p>
        ...
        <div id="btn" v-if='this.data.currentNum>0' @click="bro">借阅此书</div>
        <div id="btn" v-else class="gray">无法借阅</div>
      <index></index>
  </div>
</template>
<script>
